...
switch(d.inlineType){case "stacked":d=a.name+"-groups .inline-related";b(d).stackedFormset(d,a.options);break;case "tabular":d=a.name+"-groups .tabular.inline-related tbody:first > tr",b(d).tabularFormset(d,a.options)}})})})(django.jQuery);
